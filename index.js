...
var deviceHost = '192.168.16.200'; // This is the IP address shown in Arduino IDE Serial Monitor after uploading Firmata
var deviceID = 'UnstoppableNerdMachine'; // This is the deviceID you entered in iothub-explorer
var deviceKey = 'aJWcJJaBZuUFrG4Z5Gzb1wTj0OHa9fgfCiWN1IN2PhM='; // This is the primary key returned by iothub-explorer

var path = require('path');
var server = require('codemash-nodebots-server');
...
board.on('ready', function() {
  ...
  var connectCallback = function(err) {
    if (err) {
      console.error('Your device is not connected to the web dashboard. Could not connect: ' + err.message);
    } else {
